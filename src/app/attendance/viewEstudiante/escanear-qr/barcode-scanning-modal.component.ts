...
export class BarcodeScanningModalComponent
    ...
    public async closeModal(barcode?: Barcode): Promise<void> {
        console.log('closeModal: Cerrando modal con código', barcode);
    ...
    public async toggleTorch(): Promise<void> {
        console.log('toggleTorch: Alternando linterna');
        await BarcodeScanner.toggleTorch();
    }

    private async startScan(): Promise<void> {
        // Hide everything behind the modal (see `src/theme/variables.scss`)
        console.log('startScan: Mostrando modal');
    ...
    private async stopScan(): Promise<void> {
        ...
        console.log('stopScan: Deteniendo escaneo');
    }
}